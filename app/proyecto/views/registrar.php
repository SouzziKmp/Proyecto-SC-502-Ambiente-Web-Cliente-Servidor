<?php
// views/equipos/registrar.php
// Variables disponibles: $categorias (array), $errores (array), $datos (array)
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <link rel="stylesheet" href="../css/registrar_equipo.css">
    ...
    <nav class="navbar bg-dark border-bottom border-body p-3" data-bs-theme="dark">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <ul class="d-flex align-items-center list-unstyled m-0 gap-3">
                ...
                <li><a href="equipos.php" class="nav-link text-white active">Equipos</a></li>
                ...
                <div class="col-md-6">
                    <div class="card shadow">
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="equipos.php?accion=registrar">
...
<script src="../js/registrar_equipo.js"></script>
</body>
</html>