            ...
            <div class="row align-items-center g-4">
                <div class="col-md-7">
                    ...
                    <p class="text-muted mb-4">
                        En esta seccion se puede gestionar la solicitud y consulta de prestamos de equipos tecnologicos
                ...
                <div class="col-md-6">
                    <div class="card shadow h-100 border-0">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">Complete un formulario con el usuario, equipo y fechas
                                correspondientes para registrar una nueva solicitud.</p>
                ...
                <div class="col-md-6">
                    <div class="card shadow h-100 border-0">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">Revise el listado de prestamos activos para dar seguimiento a los
                                equipos actualmente asignados.</p>
