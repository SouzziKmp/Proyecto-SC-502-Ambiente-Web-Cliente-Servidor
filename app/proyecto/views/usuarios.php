...
<body>
        ...
        <nav class="navbar bg-dark border-bottom border-body p-3" data-bs-theme="dark">
            <div class="container-fluid d-flex justify-content-between align-items-center">
                ...
                <ul id="nav-menu" class="d-flex align-items-center list-unstyled m-0 gap-3">
                    <li><a href="index.php?action=usuarios" class="nav-link active text-white">Usuarios</a></li>
    ...
    <main class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <a href="index.php?action=registrar" class="btn btn-success"><i class="bi bi-person-plus"></i> Registrar nuevo usuario</a>
                    ...
                    <table class="table table-striped table-hover mb-0">
                        ...
                        <tbody id="tablaUsuarios">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?action=editar_usuario&id=<?= $u['id_usuarios'] ?>" class="btn btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
                                    <a href="index.php?action=eliminar_usuario&id=<?= $u['id_usuarios'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Eliminar usuario?')"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
